...
VALUES (7, 'LG DoorCooling',
        'Исполнение: отдельностоящий,система охлаждения: No Frost,количество компрессоров: 1,количество полок: 4, количество отделений морозильной камеры: 3,общий объём: 419л, полезный объем: 384л, уровень шума: 35 дБ',
        1100, 'lg.jpeg', 4);
INSERT INTO products(id, name, description, price, image_path, category_id)
VALUES (8, 'Indesit ITR', 'Исполнение: отдельностоящий,система охлаждения: No Frost,количество компрессоров: 1,количество полок: 3, количество отделений морозильной камеры: 3, полезный объем: 257л, уровень шума: 43 дБ', 1100,
        'indesit.jpeg', 4);
INSERT INTO products(id, name, description, price, image_path, category_id)
...
INSERT INTO products(id, name, description, price, image_path, category_id)
VALUES (11, 'GoPro HERO10', 'Разрешение видеосъёмки: 5.3K, размер экрана: 2.27, количество точек матрицы: 23 Мп, электронная стабилизация: HyperSmooth 4.0, количество кадров в секунду: 240 кадров/с, емкость аккумулятора: 1720 мАч', 1100, 'gopro.jpeg', 6);
INSERT INTO products(id, name, description, price, image_path, category_id)
