...
INSERT INTO products(id, name, description, price, image_path, category_id)
VALUES (11, 'GoPro HERO10', 'Разрешение видеосъёмки: 5.3K, формат сжатия видео: H.264, H.265 (HEVC), размер экрана: 2.27, количество точек матрицы: 23 Мп, электронная стабилизация: HyperSmooth 4.0, количество пикселей при фотосъемке: 23 Мп, максимальное количество кадров в секунду: 240 кадров/с, емкость аккумулятора: 1720 мАч', 1100, 'gopro.jpeg', 6);
INSERT INTO products(id, name, description, price, image_path, category_id)
